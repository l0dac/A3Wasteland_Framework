...
diag_log format ["DEBUG fn_buyVehicle: _this:%1", _this];
...
switch (_shopCfgName) do
{
	case "helicopters":
	{
		...
		{
			_obj = createVehicle [_itemClass, (position _player), [], 10, "NONE"];
	...
	case "boats":
	{
		...
		for "_i" from 1 to _quanity do
		{
			_obj = createVehicle [_itemClass, (position _player), [], 5, "NONE"];
			// TODO Object Persistence
		};
	};
