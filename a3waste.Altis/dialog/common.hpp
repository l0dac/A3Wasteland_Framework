...
class waste_RscLine : waste_RscText {
	idc = -1;
	style = 176;
	x = 0.17;
	y = 0.48;
...
class waste_RscTextRight : waste_RscText {
	style = 1;
};

class waste_RscPicture {
	idc = -1;
	shadow = 0;
	type = 0;
	style = 48;
...
class waste_RscPictureKeepAspect : waste_RscPicture
{
	style = 0x30 + 0x800;
};

class waste_RscStructuredText {
	idc = -1;
	type = 13;
	style = 0;
	x = 0;
...
class waste_RscStructuredText_Center {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class waste_RscButtonTextOnly : waste_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
...
class waste_RscButtonMenu : waste_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class waste_RscShortcutButtonMain : waste_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class waste_RscListBox_legacy
{
	...
	class ListScrollBar: waste_RscScrollBar
	{
		color[] = {1,1,1,1};
		autoScrollEnabled = 1;
	};
...
class waste_RscBackground : waste_RscText {
	type = 0;
	idc = -1;
	style = 512;
	shadow = 0;
...
class waste_RscCombo {
	...
	class ComboScrollBar : waste_RscScrollBar {};
};
